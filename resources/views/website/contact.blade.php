...
<head>
    ...
    <title> Contact || Nexin|| Nexin HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <link rel="stylesheet" href="resources/css/custom-animate.css" />
    <link rel="stylesheet" href="resources/css/swiper.min.css" />
    <link rel="stylesheet" href="resources/css/font-awesome-all.css" />
    <link rel="stylesheet" href="resources/css/jquery.magnific-popup.css" />
    <link rel="stylesheet" href="resources/css/odometer.min.css" />
    ...
    <link rel="stylesheet" href="resources/css/module-css/slider.css" />
    <link rel="stylesheet" href="resources/css/module-css/footer.css" />
    <link rel="stylesheet" href="resources/css/module-css/banner.css" />
    <link rel="stylesheet" href="resources/css/module-css/explore.css" />
    <link rel="stylesheet" href="resources/css/module-css/about.css" />
    <link rel="stylesheet" href="resources/css/module-css/brand.css" />
    <link rel="stylesheet" href="resources/css/module-css/services.css" />
    <link rel="stylesheet" href="resources/css/module-css/counter.css" />
    <link rel="stylesheet" href="resources/css/module-css/video.css" />
    <link rel="stylesheet" href="resources/css/module-css/portfolio.css" />
    <link rel="stylesheet" href="resources/css/module-css/process.css" />
    <link rel="stylesheet" href="resources/css/module-css/why-choose.css" />
    <link rel="stylesheet" href="resources/css/module-css/team.css" />
    <link rel="stylesheet" href="resources/css/module-css/testimonial.css" />
    <link rel="stylesheet" href="resources/css/module-css/faq.css" />
    <link rel="stylesheet" href="resources/css/module-css/contact.css" />
    <link rel="stylesheet" href="resources/css/module-css/blog.css" />
    <link rel="stylesheet" href="resources/css/module-css/awards.css" />
    <link rel="stylesheet" href="resources/css/module-css/sliding-text.css" />
    <link rel="stylesheet" href="resources/css/module-css/page-header.css" />

    <!-- template styles -->
    <link rel="stylesheet" href="resources/css/style.css" />
    <link rel="stylesheet" href="resources/css/responsive.css" />
    <link rel="stylesheet" href="resources/css/color-3.css" />
</head>
...
<body class="custom-cursor">
    ...
    <div id="chat-popup" class="chat-popup">
        <div class="popup-inner">
            ...
            <div class="chat-form">
                ...
                <form action="resources/inc/sendemail.php" method="POST" class="contact-form-validated">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-menu-four__wrapper-inner">
                        <div class="main-menu-four__left">
                            <div class="main-menu-four__logo">
                                <a href="index.html"><img src="resources/images/resources/logo-3.png" alt=""></a>
                            </div>
                        </div>
                                                    ...
                                                    <div class="home-showcase__inner">
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="home-showcase__item">
                                                                    <div class="home-showcase__image">
                                                                        <img src="resources/images/home-showcase/home-showcase-1-1.jpg"
                                                                            alt="">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="home-showcase__item">
                                                                    <div class="home-showcase__image">
                                                                        <img src="resources/images/home-showcase/home-showcase-1-2.jpg"
                                                                            alt="">
                                                                        <div class="home-showcase__buttons">
                                                                            <a href="index2.html"
                                                                                class="thm-btn home-showcase__buttons__item">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="home-showcase__item">
                                                                    <div class="home-showcase__image">
                                                                        <img src="resources/images/home-showcase/home-showcase-1-3.jpg"
                                                                            alt="">
                                                                        <div class="home-showcase__buttons">
                                                                            <a href="index3.html"
                                                                                class="thm-btn home-showcase__buttons__item">
        ...
        <section class="page-header">
            <div class="page-header__bg" style="background-image: url(resources/images/backgrounds/page-header-bg.jpg);">
            </div>
            <div class="container">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="contact-page__bottom-right">
                                ...
                                <form class="contact-form-validated contact-page__form"
                                    action="resources/inc/sendemail.php" method="POST">
                                    <div class="row">
                                        <div class="col-xl-12">
        ...
        <footer class="site-footer-two">
            <div class="site-footer-two__bg-shape"
                style="background-image: url(resources/images/shapes/site-footer-two-bg-shape.png);"></div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget-two__column footer-widget-two__about">
                                <div class="footer-widget-two__logo">
                                    <a href="index.html"><img src="resources/images/resources/footer-logo.png" alt=""></a>
                                </div>
                                <div class="footer-widget-two__place">
                                    <div class="footer-widget-two__place-single">
                                        <h4 class="footer-widget-two__place-title">New Work</h4>
                                        <p class="footer-widget-two__place-text">Travel World House, Level<br> 7, 17
                                            Jones St, NSW,</p>
                                    </div>
                                    <div class="footer-widget-two__place-single">
                                        <h4 class="footer-widget-two__place-title">London</h4>
                                        <p class="footer-widget-two__place-text">Travel World House, Level<br> 7, 17
                                            Jones St, NSW,</p>
                                    </div>
                                </div>
                                <div class="site-footer-two__social">
                                    ...
                                    <a href="#"><i class="icon-beeeee"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget-two__column footer-widget-two__company">
                                <div class="footer-widget-two__title-box">
                                    <h3 class="footer-widget-two__title">Company</h3>
                                </div>
                                <ul class="footer-widget-two__link-list list-unstyled">
                                    <li><a href="index.html">Home</a></li>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="footer-widget-two__column footer-widget-two__newsletter">
                                <div class="footer-widget-two__title-box">
                                    <h3 class="footer-widget-two__title">Newsletter</h3>
                                </div>
                                <p class="footer-widget-two__newsletter-text">Feel free to reach out if you want to
                                    collaborate with us, or simply have a chat.</p>
                                <form class="footer-widget-two__newsletter-form">
                                    <div class="footer-widget-two__newsletter-form-input-box">
                                        <div class="footer-widget-two__newsletter-icon">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer-two__bottom-inner">
                                <p class="site-footer-two__bottom-text">Copyright © 2025 <a href="#">Nexin</a>. All
                                    Rights Reserved.
                                </p>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="resources/images/resources/logo-4.png" width="150"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">needhelp@Nexin.com</a>
                </li>
                <li>
    ...
    <script src="resources/js/marquee.min.js"></script>
    <script src="resources/js/aos.js"></script>
    <script src="resources/js/gsap/gsap.js"></script>
    <script src="resources/js/gsap/ScrollTrigger.js"></script>
    <script src="resources/js/gsap/SplitText.js"></script>
    <script src="resources/js/jquery.circleType.js"></script>
    <script src="resources/js/jquery.fittext.js"></script>
    <script src="resources/js/jquery.lettering.min.js"></script>
